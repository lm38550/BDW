...
<head>
    ...
    <title>Mon gestionnaire d'école de danse.</title>
...
<body>
    ...
    include('static/ecole_header.php');
    
    /* Inclusion du menu*/
	include('static/ecole_menu.php'); 
	?>
    ...
    <!-- Définition du bloc proncipal -->
		...
		$controleur = 'ecole_mainboard_controleur.php';
		$vue = 'ecole_mainboard_vue.php'; 
		...
		if(isset($_GET['page'])) {
			...
			$controleur = 'ecole_' . $nomPage . '_controleur.php';
			$vue = 'ecole_' . $nomPage . '_vue.php';
		}
