...
<head>
    ...
    <title>Mon gestionnaire d'Ecoles de Danse et de fédérations.</title>
    
    <!-- lien vers le style CSS externe  -->
    <link href="css/style.css" rel="stylesheet" media="all" type="text/css">
    
    <!-- lien vers une image favicon (qui apparaitra dans l'onglet du navigateur) -->
    <link rel="shortcut icon" type="image/x-icon" href="img/dance.png" />
</head>
<body>
    <?php 
    ...
    <!-- Définition du bloc proncipal -->
		...
		$controleur = 'index_controleur.php';
		$vue = 'index_vue.php'; 
